...
### 🔐 加密/解密工具
專業的文字加密解密工具，支援多種演算法
- 🔒 **對稱加密**: AES、DES、3DES、RC4、Rabbit
- 🔑 **非對稱加密**: RSA (2048/4096位元)
- 🎛️ **加密模式**: GCM、CBC、ECB、CFB、OFB、CTR
- 🎲 自動生成安全的金鑰和 IV
- 📊 支援 Base64 和 Hex 輸出格式
- 💾 本地處理，保護隱私

### 🔤 編碼工具
多功能文字編碼、解碼與雜湊工具
- 🔄 **可逆編碼**: Base64、Hex、URL 編碼/解碼
- 🔐 **雜湊演算法**: MD5、SHA-1、SHA-256、SHA-512
- ⚙️ Base64 進階選項（URL-safe、自動斷行）
- 🌐 完整支援中文和特殊字元
- ⚡ 即時轉換
- 📋 一鍵複製
